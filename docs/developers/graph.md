...
In causalprog, directed acyclic graphs (DAGs) are used to represent
causal problems. This documentation page describes how these graphs
are implemented, and is aimed at developers of the library.
Documentation for users can be found in [the documentation for
users](../users/graph.md).

## Graphs

Graphs in causalprog are internally stored as
[networkx](https://networkx.org/) graphs, with nodes being instances
